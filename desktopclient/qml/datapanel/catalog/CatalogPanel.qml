    ...
    ToolBar{
        ...
        RowLayout{
            ...
            ToolButton{
                ...
                iconSource: iconsource("list20.png")
                checkable: true
                checked: true
            ...
            ToolButton{
                id : showGrid
                implicitHeight: heightButtons
                iconSource: iconsource("grid20.png")
                checkable: true
                checked: false
                exclusiveGroup: catalogViewStatus
            }
            ToolButton{
                id : showThumbs
                implicitHeight: heightButtons
                iconSource: iconsource("thumblist20.png")
                checkable: true
                checked: false
                exclusiveGroup: catalogViewStatus
            }
            ...
            ToolButton{
                id : showRasters
                implicitHeight: heightButtons
                iconSource: iconsource("raster20.png")
                checkable: true
                checked: true
            ...
            ToolButton{
                id : showFeatures
                implicitHeight: heightButtons
                iconSource: iconsource("feature20.png")
                checkable: true
                checked: true
            ...
            ToolButton{
                id : showTables
                implicitHeight: heightButtons
                iconSource: iconsource("table20.png")
                checkable: true
                checked: true
