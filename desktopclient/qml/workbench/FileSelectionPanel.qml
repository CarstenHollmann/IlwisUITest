...
Rectangle {
    ...
    Rectangle {
        ...
        Action {
            id : goPath
            onTriggered :{
                privateProperty.currentFolder = "file:///"+ pathText.editText
                folderModel.folder = privateProperty.currentFolder
                mastercatalog.addCatalog(privateProperty.currentFolder)
                mastercatalog.setWorkingCatalog(privateProperty.currentFolder)
            }
        }
            ...
            delegate: Item {
                ...
                MouseArea{
                    ...
                    onClicked: {
                        ...
                        privateProperty.currentFolder = "file:///"+ path;
                        folderModel.folder = privateProperty.currentFolder;
                        mastercatalog.setWorkingCatalog(privateProperty.currentFolder)
                    }
